...
// import { CheckCircle, User, Briefcase, Shield, DollarSign, Users, ArrowRight, Wrench } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: "Fill out a short form describing your yard work needs. Add photos if helpful and choose your preferred date."
    },
    {
      // icon: <User className="w-6 h-6" />,
      title: "Get Matched Fast",
      description: "We quickly match you with a qualified, nearby worker who can handle your specific yard work needs."
    },
    {
      // icon: <CheckCircle className="w-6 h-6" />,
      title: "Job Gets Done",
      description: "Your worker arrives on time, completes the task professionally, and you pay after the job is finished."
    }
  ];
  ...
  const features = [
    {
      ...
      title: "Trusted & Safe",
      description: "All workers are background checked and vetted for your peace of mind."
    },
    {
      // icon: <DollarSign className="w-5 h-5" />,
      title: "No Long Contracts",
      description: "Book one job at a time. No commitments or subscription required."
    },
    {
      // icon: <DollarSign className="w-5 h-5" />,
          ...
          {steps.map((step, index) => (
            <div key={index} className="text-center">
              <div className="flex flex-col items-center mb-4">
                <div className="w-14 h-14 bg-gray-900 rounded-full flex items-center justify-center text-white mb-3">
                  {step.icon}
                </div>
