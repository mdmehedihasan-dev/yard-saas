    ...
    <div className="bg-white border border-gray-200 rounded-lg p-5 mb-4 hover:shadow-md transition-shadow">
      ...
      <div className="flex justify-between items-center">
        <span className="text-sm text-gray-500">
          {job.priceLabel || 'Total'}: <span className="font-semibold text-gray-900">{getPriceDisplay(job.price)}</span>
        </span>
        {job.action && (
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-6 py-4">
          ...
          <p className="text-sm text-gray-600 mt-1">Track and manage your jobs and requests</p>
        </div>
      </header>
